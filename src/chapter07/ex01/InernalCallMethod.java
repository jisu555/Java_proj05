...
public class InernalCallMethod {
	...
	public static void main(String[] args) {
		// 클래스 내부에서 다른 메소드 호출
			...
			//static : 인스턴스화 하지않고 사용 가능하다. 객체를 생성하지 않고 사용 가능하다.
		...
		//sum2는 바로 호출 시 오류가 발생 <== 객체화해서 호출
	//	double de= sum2(20,33.3);		//객체화 하지않아서 오류 발생
	...
	// 메소드 이름앞에 static키를 넣으면 객체 생성 없이 호출이 가능함.
	...
	// static키 없이 메소드 생성 : 인스턴스메소드(객체화 해야 호출이 가능)
