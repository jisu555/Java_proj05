...
class Human {	// 부모클래스(Super class) : 자식클래스의 공통된 특징을 저장 (필드, 메소드)
...
public class Inheritance01 {
	...
	public static void main(String[] args) {
		// 상속 (Inheritance) : 부모 클래스의 필드(속성)와 메소드(기능)를 자식클래스에서 물려받아서 사용
			...
			// 배열이나 컬렉션에 부모클래스 이름으로(업캐스팅) 저장해서 출력 가능
		...
		s1.StudnetID = 2222;
		System.out.println(s1.StudnetID);
		s1.goToSchool();
		...
		//자신의 클래스의 필드와 메소드 출력
		w1.workderID = 3333;
		System.out.println(w1.workderID);
		w1.goToWork();
