...
public class TypeCasting01 {
	...
	public static void main(String[] args) {
		...
		//2. 다운캐스팅 : Animal (부모 타입) --> Tiger (자식 타입), 수동으로 명시
			//a1 : Tiger 필드, 메소드 + Animal 필드와 메소드도 포함.
		...
		//
		//다운캐스팅 : 실행 시 오류 발생, t3에는 TigerChild는 내포하고 있지 않기 때문에
			//다운캐스팅 실행 시 오류 발생
		...
		//다운캐스팅 할 때에는 반드시 instanceof를 사용해야 한다.
		...
		//t6 (TigerChild) ---> Animal   (업캐스팅은 명시 안해도 됨)
