...
class Bb {		// Object의 equals() 를 재정의해서 Heap의 값 비교하도록 설정
	//필드 1
	String name;
...
public class Object_Method2 {
	...
	public static void main(String[] args) {
		// Object 클래스의 equals() 메소드 : 	기본적으로 == 참조 주소를 비교함.
			 // 객체의 Heap의 값을 비교하는 것이 아니라 Stack 메모리의 참조주소값을 비교.
		// String 클래스는 equals() 메소드가 재정의 되어있어서 Heap 값을 비교하도록 설정이 되어있다.
		
		
		String s1 = new String("안녕");
		String s2 = new String("안녕");
		
		// == : 참조 자료형에서는 stack영역의 참조 주소를 비교.
		// equals() : ==
		...
		System.out.println(b1 == b2);	//stack의 참조주소를 비교, false
			//equals() 메소드를 재정의해서 Heap 값을 비교하도록 설정
