package chapter10.ex09;import java.security.PKCS12Attribute;
...
class Student {
	...
	public void setMonth(int month) {
		...
		this.month = month;
			...
			System.out.println("잘못된 입력 값이니다. 1 ~ 12 사이의 정수값을 넣으세요.");
			return;
		}
	}
...
public class Initial_Field01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(s1);			// 객체를 출력할 때 toString() 메소드가 호출이 됨
