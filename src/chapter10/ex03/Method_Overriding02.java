...
public class Method_Overriding02 {
	...
	public static void main(String[] args) {
		...
		//객체 생성
		Animal t1 = new Tiger();   //t1 : Animal, Tiger 타입을 내포하고 있음
		...
		t1.animalSound();	//Animal의 animalSound 호출 시 Tiger의 animalSound가 출력
		t2.animalSound();	//Animal의 animalSound 호출 시 Lion의 animalSound가 출력 
		t3.animalSound();	//Animal의 animalSound 호출 시 Eagle의 animalSound가 출력
