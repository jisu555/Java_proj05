...
class Eagle extends Animal {
	int eagleNo;
	void eagleMethod() {
		System.out.println("Eagle의 클래스 메소드");
	}
	@Override
	void cry() {
...
class TigerChild extends Tiger{
	...
	void tigerChildMethod() {
		System.out.println("TigerChild의 클래스 메소드");
	}
	void cry() {
...
public class MethodOverriding_test {
	...
	public static void main(String[] args) {
		...
		//1. 객체의 타입
		//a1 : Animal객체를 내포하고있고 Animal의 필드와 메소드 접근 가능
		...
		//t1은 Animal, Tiger를 내포하고 있고, Tiger타입으로 지정(Animal, Tiger의 필드와 메소드 접근)
		Tiger t1 = new Tiger();
		//부모의 필드와 메소드 호출
		t1.name = "호랑이1";
		t1.age = 5;
		...
		//3. Tiger 객체를 생성하면서 Animal타입으로 지정 (Animal의 필드와 메소드만 접근)
		//a2 : Animal, Tiger
		Animal a2 = new Tiger();
		//Animal의 필드와 메소만 접근
		a2.name = "호랑이2";
		...
		Tiger t2 = (Tiger) a2;	 //다운캐스팅할때는 반드시 instanceof 를 사용을 해야 한다.
		...
		Animal a29 = new Animal();	//a29 : Animal객체만 내포
		Animal a30 = new Tiger();	//a30 : Animal, Tiger 객체 내포
		Animal a31 = new Eagle();	//a31 : Animal, Eagle 객체 내포
