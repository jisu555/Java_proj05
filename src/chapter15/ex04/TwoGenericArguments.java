...
public class TwoGenericArguments {
	...
	public static void main(String[] args) {
		...
		System.out.println("key : " + key1 + "value : " + val1);  //변수에 넣고 출력한거
		
		System.out.println(kv1.getKey() + "," + kv1.getValue());  //바로 출력한거
		...
		//3. <String, Void>    <== Void : 해당 필드를 사용하지 않음. :주의 Void >> wrapper class에 들어갈때는 첫자가 대문자
