...
class Test {
	void method1 (Goods<A> g) {}	  		  //case 1  : g에 A타입만 인풋가능
	void method2 (Goods<?> g) {}	  		  //case 2	: ? : 모든 클래스 가능 A,B,C,D
	void method3 (Goods<? extends B> g) {}	  //case 3	: B,C,D  가능 
	void method4 (Goods<? super B> g) {}	  //case 4	: B,A만 가능
 }
