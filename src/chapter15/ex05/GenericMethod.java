...
class GenericMethods {
	...
	// 제너릭에 넣는 타입변수 T에 올 수 있는 것은 기본 타입은 넣을 수 없다. wrapper클래스만 올 수 있다.
...
public class GenericMethod {
	...
	public static void main(String[] args) {
		...
		String str2 = gm.method1("하세요");  //뒤에 인풋값으로 타입을 유추할 수 있는 경우 생략 가능
		...
		System.out.println(gm.<Double>method1(100.11));  //변수에 안넣고 바로 출력한거
