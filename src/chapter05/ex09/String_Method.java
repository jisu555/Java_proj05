...
public class String_Method {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.indexOf('a'));      //문자 a가 저장된 방번호를 출력 : 7
		System.out.println(str1.lastIndexOf('a'));  //9
		
		System.out.println(str1.indexOf('a', 8));	    //8번방부터 a를 검색 : 9 (방향 : -->)
		System.out.println(str1.lastIndexOf('a', 8));   //7 (방향 : <--)
	...
	//	String str4 = true;	 //boolean타입을 String 변수에 저장시 오류
		...
		//getBytes() : 문자열을 1글자씩 잘라서 byte배열에 저장, 아스키 코드값이 출력
		...
		//5. 문자열 수정, 대문자로 출력 : toUpperCase(), 소문자로변환 :  toLowerCase
		...
		System.out.println(str13.substring(0,5));  //0번에서 시작해서 4번방 앞까지 
